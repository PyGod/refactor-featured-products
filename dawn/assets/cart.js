  ...
  constructor() {
    ...
    this.addEventListener('click', (event) => {
      ...
      if (button) {
        ...
        cartItems.updateQuantity(this.dataset.index, 0, event, null, variantId);
      } else {
...
class CartItems extends HTMLElement {
  ...
  async onCartUpdate() {
    if (this.tagName === 'CART-DRAWER-ITEMS') {
      ...
      try {
        ...
        const responseText_1 = await response_1.text();
        const html_1 = new DOMParser().parseFromString(
          responseText_1,
          'text/html'
        );
        const sourceQty = html_1.querySelector('cart-items');
  ...
  updateQuantity(line, quantity, event, name = null, variantId) {
